            ...
            Event::class => [
                'collection-schema' => [
                    'fields' => [
                        ...
                        ['name' => 'admin_area_1_id', 'type' => 'string', 'optional' => true, 'facet' => true],
                        ['name' => 'admin_area_2_id', 'type' => 'string', 'optional' => true, 'facet' => true],
            ...
            Person::class => [
                'collection-schema' => [
                    'fields' => [
                        ...
                        ['name' => 'admin_area_1_id', 'type' => 'int32', 'optional' => true, 'facet' => true],
                        ['name' => 'admin_area_2_id', 'type' => 'int32', 'optional' => true, 'facet' => true],
