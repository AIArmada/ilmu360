            ...
            Event::class => [
                'collection-schema' => [
                    'fields' => [
                        ...
                        ['name' => 'administrative_district_id', 'type' => 'string', 'optional' => true, 'facet' => true],
                        ['name' => 'administrative_subdivision_id', 'type' => 'string', 'optional' => true, 'facet' => true],
                        ['name' => 'postal_locality_id', 'type' => 'string', 'optional' => true, 'facet' => true],
