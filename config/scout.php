            ...
            Event::class => [
                'collection-schema' => [
                    'fields' => [
                        ...
                        ['name' => 'country_id', 'type' => 'string', 'optional' => true, 'facet' => true],
                        ['name' => 'state_id', 'type' => 'string', 'optional' => true, 'facet' => true],
                        ['name' => 'city_id', 'type' => 'string', 'optional' => true, 'facet' => true],
                        ['name' => 'administrative_division', 'type' => 'string', 'optional' => true, 'facet' => true],
                        ['name' => 'administrative_district', 'type' => 'string', 'optional' => true, 'facet' => true],
                        ['name' => 'administrative_subdivision', 'type' => 'string', 'optional' => true, 'facet' => true],
                        ['name' => 'postal_locality', 'type' => 'string', 'optional' => true, 'facet' => true],
                        ...
                        ['name' => 'event_format', 'type' => 'string', 'facet' => true],
                        ['name' => 'children_allowed', 'type' => 'bool', 'facet' => true],
                        ['name' => 'status', 'type' => 'string', 'facet' => true],
                        ['name' => 'visibility', 'type' => 'string', 'facet' => true],
                        ['name' => 'occurrence_status', 'type' => 'string', 'optional' => true, 'facet' => true],
                        ['name' => 'timing_mode', 'type' => 'string', 'facet' => true],
                        ['name' => 'discipline_tag_ids', 'type' => 'string[]', 'optional' => true, 'facet' => true],
                        ...
                        ['name' => 'saves_count', 'type' => 'int64', 'optional' => true],
                        ['name' => 'registrations_count', 'type' => 'int64', 'optional' => true],
            ...
            Person::class => [
                'collection-schema' => [
                    'fields' => [
                        ...
                        ['name' => 'administrative_subdivision_id', 'type' => 'int32', 'optional' => true, 'facet' => true],
                        ['name' => 'postal_locality_id', 'type' => 'int32', 'optional' => true, 'facet' => true],
