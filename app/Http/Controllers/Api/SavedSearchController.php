...
class SavedSearchController extends Controller
{
    ...
    private function savedSearchValidationRules(bool $partial = false): array
    {
        return [
            ...
            'filters.state_id' => 'nullable|uuid|exists:address_areas,id',
            'filters.district_id' => 'nullable|uuid|exists:address_areas,id',
            'filters.subdistrict_id' => 'nullable|uuid|exists:address_areas,id',
