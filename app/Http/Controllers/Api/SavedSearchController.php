...
class SavedSearchController extends Controller
{
    ...
    private function savedSearchValidationRules(bool $partial = false): array
    {
        return [
            ...
            'filters.admin_area_3_id' => 'nullable|uuid|exists:address_areas,id',
            'filters.admin_area_4_id' => 'nullable|uuid|exists:address_areas,id',
            ...
            'filters.person_in_charge_ids.*' => 'uuid|exists:speakers,id',
