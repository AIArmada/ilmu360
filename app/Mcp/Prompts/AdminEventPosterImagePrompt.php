...
#[Description('Builds a 3:4 portrait poster prompt for an admin-accessible event with the event data and brand reference images attached. Use the returned prompt and images with ChatGPT image generation, then upload the result with admin-upload-event-poster-image.')]
