...
#[Name('admin-event-cover-image-prompt')]
#[Title('Event Cover Image Prompt')]
#[Description('Builds a 16:9 cover image prompt for an admin-accessible event with the event data and brand reference images attached. Use the returned prompt and images with ChatGPT image generation, then upload the result with admin-upload-event-cover-image.')]
class AdminEventCoverImagePrompt extends Prompt
{
