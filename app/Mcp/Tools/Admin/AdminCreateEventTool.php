...
class AdminCreateEventTool extends AbstractAdminWriteTool
{
    ...
    private function buildEventPayload(array $validated): array
    {
        ...
        if ($primaryOrganizerKey !== null) {
            $payload['primary_organizer_id'] = $this->resolvePrimaryOrganizerIdentifier(
    ...
    public function schema(JsonSchema $schema): array
    {
        return [
            ...
            'languages' => $schema->array()->items($schema->string())->nullable()->description('Array of language record UUIDs for the event language(s). Use admin-list-records on the languages resource to discover available IDs.'),
