...
class VerifiedDocumentationCatalog
{
    ...
    public function all(): array
    {
        return array_values(array_map(
            ...
            $this->documentationLibrary->forAudience(DocumentationLibrary::AUDIENCE_MCP_ADMIN),
        ));
    }

    public function hasAnyDocuments(): bool
    {
        return $this->documentationLibrary->hasAnyDocumentsForAudience(DocumentationLibrary::AUDIENCE_MCP_ADMIN);
    }
    ...
    {
        $document = $this->documentationLibrary->findForAudience(DocumentationLibrary::AUDIENCE_MCP_ADMIN, $id);
    ...
    {
        return $this->documentationLibrary->searchForAudience(DocumentationLibrary::AUDIENCE_MCP_ADMIN, $query);
    }
    ...
    {
        return $this->documentationLibrary->fetchForAudience(DocumentationLibrary::AUDIENCE_MCP_ADMIN, $id);
    }
}
