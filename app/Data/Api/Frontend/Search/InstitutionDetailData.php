...
class InstitutionDetailData extends Data
{
    ...
    public static function fromModel(
        ...
        return new self(
            ...
            address: $address,
            country: $country,
            map_url: $institution->primaryAddress()?->google_maps_url,
            map_lat: $institution->primaryAddress()?->latitude,
            map_lng: $institution->primaryAddress()?->longitude,
            ...
            waze_url: $institution->primaryAddress()?->waze_url,
